...
BOOST_PYTHON_MODULE(Big_integer)
{
    class_<Big_integer>( "Big_integer")
    	.def(init<const char*>(args()))
    	.def(init<Big_integer&>(args()))
    	.def(init<int>(args()))
    	.def("GetString",&Big_integer::GetString)
        .def("ReadFromTextFile",&Big_integer::ReadFromTextFile,args("FileName"))
        .def("WriteToTextFile",&Big_integer::WriteToTextFile,args("FileName"))
        .def("WriteToBin",&Big_integer::WriteToBin,args("FileName"))
        .def("ReadFromBin",&Big_integer::ReadFromBin,args("FileName"))
        .def("operator>",&Big_integer::operator>,args("Y"))
        .def("operator>=",&Big_integer::operator>=,args("Y"))
        .def("operator<",&Big_integer::operator<,args("Y"))
        .def("operator<=",&Big_integer::operator<=,args("Y"))
        .def("operator==",&Big_integer::operator==,args("Y"))
        .def("operator!=",&Big_integer::operator!=,args("Y"))
        .def("operator++",static_cast< Big_integer (Big_integer::*)() >( &Big_integer::operator++))
        .def("operator++",static_cast< Big_integer (Big_integer::*)(int) >( &Big_integer::operator++),args(""))
        .def("operator--",static_cast< Big_integer (Big_integer::*)() >( &Big_integer::operator--))
        .def("operator--",static_cast< Big_integer (Big_integer::*)(int) >( &Big_integer::operator--),args(""))
        .def("operator=",&Big_integer::operator=,args(RValue))
        .def("operator+",&Big_integer::operator+,args(RValue))
        .def("operator-",static_cast< Big_integer (Big_integer::*)() >( &Big_integer::operator-))
        .def("operator-",static_cast< Big_integer (Big_integer::*)(Big_integer&) >( &Big_integer::operator++),args("RValue"))
        .def("operator*",&Big_integer::operator*,args(RValue))
        .def("operator/",&Big_integer::operator/,args(RValue))
        .def("operator%",&Big_integer::operator%,args(RValue))
        .def("operator^",&Big_integer::operator^,args(RValue))
